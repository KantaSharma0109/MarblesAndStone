...
class AppSliderWidget extends StatelessWidget {
  const AppSliderWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return CarouselSlider.builder(
      itemCount: context.watch<MainContainerViewModel>().appslider.length,
      options: CarouselOptions(
        ...
        enableInfiniteScroll:
            context.watch<MainContainerViewModel>().appslider.length == 1
                ? false
                : true,
      ),
            ...
            child: GestureDetector(
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => VideoWebPage(
                        url: Provider.of<MainContainerViewModel>(context,
                                listen: false)
                            .appslider[index]
                            .image_path,
                      ),
              ...
              child: ClipRRect(
                ...
                child: Stack(
                  ...
                  children: [
                    CachedNetworkImage(
                      imageUrl: Provider.of<MainContainerViewModel>(context,
                                      listen: false)
                                  .appslider[index]
                                  .category ==
                              'video'
